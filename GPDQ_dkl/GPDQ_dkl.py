...
# ================================== Others ==================================
from GPDQ_dkl import my_exact_gp
...
class GaussianProcessDiffusionQlearning:
    ...
    def loadTrainingRecord(self, path:str=None):
        ...
        self.gp_model.g_net = _loaded_training_record['g_net']
        self.gp_model.g_train = self.gp_model.g_net(self.gp_model.x_train)
        self.gp_model.K = self.gp_model.maternKernel(self.gp_model.g_train, self.gp_model.g_train, noise=True)
    ...
    def recordSaving(self, path:str):
        torch.save({'training_record': self.training_record,
                    ...
                    'g_net': self.gp_model.g_net}, path)