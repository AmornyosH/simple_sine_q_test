...
class myExactGP(torch.nn.Module):
    def __init__(self, params_dict:dict, dataset:dict, parent_alg:str, cuda:bool=False):
        ...
        if _ans_1 == 'n' or _ans_1=='N' or _ans_1=='No' or _ans_1=='NO':
            ...
            _start = 0
            self.x_train = _training_records['x_train'][0+_start:_start+self.gp_training_size]
            self.y_train = _training_records['y_train'][0+_start:_start+self.gp_training_size]
            self.eval()
        else:
