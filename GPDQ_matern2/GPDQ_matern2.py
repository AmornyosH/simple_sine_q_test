...
# ================================== Others ==================================
from GPDQ_matern2 import my_exact_gp
    ...
    def training(self, total_epoch:int, eval:bool=False, ft:bool=False):
        ...
        while self.training_record < total_epoch:
            ...
            for g in range(_num_gradient_step):
                ...
                #     _add_diffu_loss, _ = _trainDiffusionBeh(inputs=torch.concat([self.gp_model.x_train[_gp_sampling_indices[0:_batch_size]], 
                #                                                                  _forward_batch_a_hat_tensor, 
                #                                                                  encode_t_tensor], dim=1), y_true=epsilon_tensor)
